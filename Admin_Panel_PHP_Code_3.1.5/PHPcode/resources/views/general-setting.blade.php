            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item  active"><i class="fas fas fa-cogs mr-1"></i>{{ __('general_setting') }}</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="card card-secondary h-100">
                        ...
                        <form action="{{ route('general-settings') }}" role="form" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 col-sm-12">
                                        ...
                                        <textarea name="fcm_sever_key" id="fcm_server_key" class="form-control" required>{{ $setting['fcm_sever_key'] ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
