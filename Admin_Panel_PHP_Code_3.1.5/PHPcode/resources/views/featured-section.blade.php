            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="nav-icon fas fa-layer-group mr-1"></i>{{ __('featured_section') }}</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 d-flex justify-content-end">
                    <button id="toggleButton" class="btn btn-primary mb-3 ml-1"><i class="fas fa-plus-circle mr-2"></i>{{ __('create') . ' ' . __('featured_section') }}</button>
                </div>
                <div class="col-md-12" id="add_card">
                    <div class="card card-secondary">
                        ...
                        <form id="create_form" action="{{ route('featured_sections.store') }}" role="form" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="slug" type="text" class="form-control" placeholder="{{ __('slug') }}" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="checkbox" id="is_based_on_user_choice" name="is_based_on_user_choice" class="status-switch">
                                    ...
                                    <div class="col-md-4">
                                        <div id="filter_section">
                                            <div class="form-group">
                                                ...
                                                <select id="news_type" name="news_type" class="form-control news_type" required>
                                                    <option value="">{{ __('select') . ' ' . __('news_type') }}</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="filter_type" name="filter_type" class="form-control filter_type" required>
                                                    <option value="">{{ __('select_option') }}</option>
                                                    <option value="most_commented" class="most_commented">{{ __('most_commented') }}</option>
                                                    <option value="recently_added">{{ __('recently_added') }}</option>
                                                    <option value="most_viewed">{{ __('most_viewed') }}</option>
                                                    <option value="most_favorite" class="most_favorite">{{ __('most_favorite') }}</option>
                                                    <option value="most_like" class="most_like">{{ __('most_like') }}</option>
                                                    <option value="custom">{{ __('custom') }}</option>
                                                </select>
                                            </div>
                                            @if (is_category_enabled() == 1)
                                                <div class="form-group" id="filter_news">
                                                    <label class="required">{{ __('category') }}</label>
                                                    <select id="category_ids" name="category_ids[]" class="form-control" with="100%" multiple="multiple">
                                                    </select>
                                                </div>
                                            @endif
                                            <div class="form-group" id="custom" style="display: none">
                                                <label class="required">{{ __('news') }}</label>
                                                <select id="news_ids" name="news_ids[]" class=" form-control" multiple="multiple">
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="short_description" class="form-control" placeholder="{{ __('short_description') }}" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-2 col-sm-2">
                                                <label class="radio-img">
                                                    <input type="radio" name="style_app" value="style_1" required class="form-control" />
                                                    <img src="images/app_style/App_Style_1.png" alt="style_1" class="style_image">
                                                </label>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                                <label class="radio-img">
                                                    <input type="radio" name="style_app" value="style_2" />
                                                    <img src="images/app_style/App_Style_2.png" alt="style_2" class="style_image">
                                                </label>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                                <label class="radio-img">
                                                    <input type="radio" name="style_app" value="style_3" />
                                                    <img src="images/app_style/App_Style_3.png" alt="style_3" class="style_image">
                                                </label>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                                <label class="radio-img">
                                                    <input type="radio" name="style_app" value="style_4" />
                                                    <img src="images/app_style/App_Style_4.png" alt="style_4" class="style_image">
                                                </label>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                                <label class="radio-img">
                                                    <input type="radio" name="style_app" value="style_5" />
                                                    <img src="images/app_style/App_Style_5.png" alt="style_5" class="style_image">
                                                </label>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                                <label class="radio-img">
                                                    <input type="radio" name="style_app" value="style_6" />
                                                    <img src="images/app_style/App_Style_6.png" alt="style_6" class="style_image">
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-2 col-sm-2">
                                                <label class="radio-img-web">
                                                    <input type="radio" name="style_web" value="style_1" class="form-control" required />
                                                    <img src="images/app_style/Web_Style_1.png" alt="style_1" class="style_image">
                                                </label>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                                <label class="radio-img-web">
                                                    <input type="radio" name="style_web" value="style_2" />
                                                    <img src="images/app_style/Web_Style_2.png" alt="style_2" class="style_image">
                                                </label>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                                <label class="radio-img-web">
                                                    <input type="radio" name="style_web" value="style_3" />
                                                    <img src="images/app_style/Web_Style_3.png" alt="style_3" class="style_image">
                                                </label>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                                <label class="radio-img-web">
                                                    <input type="radio" name="style_web" value="style_4" />
                                                    <img src="images/app_style/Web_Style_4.png" alt="style_4" class="style_image">
                                                </label>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                                <label class="radio-img-web">
                                                    <input type="radio" name="style_web" value="style_5" />
                                                    <img src="images/app_style/Web_Style_5.png" alt="style_5" class="style_image">
                                                </label>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                                <label class="radio-img-web">
                                                    <input type="radio" name="style_web" value="style_6" />
                                                    <img src="images/app_style/Web_Style_6.png" alt="style_6" class="style_image">
                                                </label>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-9 col-md-12 col-sm-12">
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            ...
                            <table aria-describedby="mydesc" id='table' data-toggle="table" data-url="{{ route('featuredSectionList') }}" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true"
                                data-show-columns="true" data-show-refresh="true" data-toolbar="#toolbar" data-mobile-responsive="true" data-buttons-class="primary" data-trim-on-search="false" data-sort-name="row_order" data-sort-order="asc" data-query-params="queryParams">
                                <thead>
                                    <tr>
                                        <th scope="col" data-field="id" data-sortable="true">{{ __('id') }}</th>
                                        <th scope="col" data-field="language">{{ __('language') }}</th>
                                        <th scope="col" data-field="title" data-sortable="false">{{ __('title') }}</th>
                                        <th scope="col" data-field="slug" data-sortable="false">{{ __('slug') }}</th>
                                        ...
                                        <th scope="col" data-field="short_description" data-visible="false">{{ __('short_description') }}</th>
                                        ...
                                        <th scope="col" data-field="og_image" data-visible="false">{{ __('og_image') }}</th>
                                        ...
                                        <th scope="col" data-field="row_order" data-sortable="true">{{ __('row_order') }}</th>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <div class="card card-secondary">
                        ...
                        <form id="order_form" action="{{ route('update_featured_sections_order') }}" method="post" onsubmit="return saveOrder()">
                            @csrf
                            <div class="card-body">
        ...
        <div class="modal fade" id="editDataModal">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <form id="update_form" action="{{ url('featured_sections') }}" role="form" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="required">{{ __('title') }}</label>
                                        <input id="edit_title" name="title" type="text" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="required">{{ __('slug') }}</label>
                                        <input id="edit_slug" name="slug" type="text" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="mr-2">{{ __('schema_markup') }}</label><i
                                            data-content="Schema markup, also known as structured data, is the language search engines use to read and understand the content
                                            ...
                                            Learn more about schema markup and generate it for your website using the .<a href='https://www.rankranger.com/schema-markup-generator' target='_blank'>Rank Ranger Schema Markup Generator</a>".
                                            class="fa fa-question-circle"></i>
                                        <input id="edit_schema_markup" name="schema_markup" type="text" placeholder="{{ __('schema_markup') }}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>{{ __('display_news_based_user_preference') }}</label>
                                        <div>
                                            <input type="checkbox" id="edit_is_based_on_user_choice" name="edit_is_based_on_user_choice" class="status-switch editInModel">
                                ...
                                <div class="col-md-4">
                                    <div id="edit_filter_section">
                                        ...
                                        <div class="form-group">
                                            <label class="required">{{ __('type_of_filter') }}</label>
                                            <select id="edit_filter_type" name="filter_type" class="form-control filter_type">
                                                <option value="">{{ __('select_option') }}</option>
                                                <option value="most_commented" class="most_commented">{{ __('most_commented') }}</option>
                                                <option value="recently_added">{{ __('recently_added') }}</option>
                                                <option value="most_viewed">{{ __('most_viewed') }}</option>
                                        ...
                                        <div class="form-group">
                                            @if (is_category_enabled() == 1)
                                                <div id="edit_filter_news" class="form-group">
                                                    <label class="required">{{ __('category') }}</label>
                                                    <select id="edit_category_ids" name="category_ids[]" class="form-control" multiple="multiple">
                                                    </select>
                                                </div>
                                            @endif
                                            <div id="edit_custom" class="form-group">
                                                <label class="required"> {{ __('news') }}</label>
                                                <select id="edit_news_ids" name="news_ids[]" class="form-control" multiple="multiple">
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="mr-2 required">{{ __('meta_description') }}</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="required">{{ __('short_description') }}</label>
                                        <input type="text" id="edit_short_description" name="short_description" class="form-control" placeholder="{{ __('short_description') }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="required">{{ __('meta_keywords') }}</label>
                                        <input id="edit_meta_tags" class="w-100" type="text" name="meta_keyword" style="border-radius: 0.25rem" placeholder="{{ __('press_enter_add_keywords') }}">
                                    </div>
                                    <div class="form-group">
                                        <label class="required">{{ __('meta_title') }}</label>
                                        <input id="edit_meta_title" name="meta_title" type="text" required oninput="getWordCount('edit_meta_title','edit_meta_title_count','19.9px arial')" placeholder="{{ __('meta_title') }}" class="form-control">
...
@section('script')
    <script type="text/javascript">
        window.actionEvents = {
            'click .edit-data': function(e, value, row, index) {
                $("#edit_language_id").val(row.language_id).trigger('change', [row.language_id, row.category_id, row.subcategory_id, row.news_id, row.filter_type, row.news_type]);
                $('#edit_id').val(row.id);
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '#edit_language_id', function(e, row_language_id, row_category_id, row_subcategory_id, row_news_id, row_filter_type, row_news_type) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $("#edit_filter_type").val(row_filter_type).trigger('change', [row_filter_type, row_news_id]);
                    $("#edit_news_type").val(row_news_type).trigger('change', [row_filter_type, row_news_id, row_category_id, row_subcategory_id]);
                },
        ...
        $(document).on('change', '#edit_news_type', function(e, row_filter_type, row_news_id, row_category_id, row_subcategory_id) {
            var news_type = $(this).val();
            if (news_type == 'videos') {
