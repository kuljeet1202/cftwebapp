        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 d-flex justify-content-end">
                    <button id="toggleButton" class="btn btn-primary mb-3 ml-1"><i class="fas fa-plus-circle mr-2"></i>{{ __('create') . ' ' . __('pages') }}</button>
                </div>
                <div class="col-md-12" id="add_card">
                    <div class="card card-secondary">
                        ...
                        <form id="create_form" action="{{ route('pages.store') }}" role="form" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="slug" name="slug" placeholder="{{ __('slug') }}" type="text" class="form-control">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="meta_tags" name="meta_keyword" style="border-radius: 0.25rem" class="w-100" type="text" placeholder="{{ __('press_enter_add_keywords') }}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="meta_description" name="meta_description" class="form-control" required oninput="getWordCount('meta_description','meta_description_count','12.9px arial')"></textarea>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="og_file" type="file" accept="image/*" class="filepond" required>
                                        </div>
                                        <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            ...
                            <table aria-describedby="mydesc" id='table' data-toggle="table" data-url="{{ route('pagesList') }}" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" data-field="page_content" data-visible="false">{{ __('page_content') }}</th>
        ...
        <div class="modal fade" id="editDataModal">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <form id="update_form" action="{{ url('pages') }}" role="form" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
    ...
    <script type="text/javascript">
        window.actionEvents = {
            'click .edit-data': function(e, value, row, index) {
                ...
                $('#edit_page_type').val(row.page_type).trigger('change');
