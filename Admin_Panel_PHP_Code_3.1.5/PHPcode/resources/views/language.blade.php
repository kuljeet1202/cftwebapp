                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3 col-sm-12">
                                        ...
                                        <a class="btn btn-info form-control" href="{{ url('sample-download') }}">{{ __('download_sample_file') }}</a>
                                    </div>
                                    <div class="form-group col-md-3 col-sm-12">
                                        ...
                                        <a class="btn btn-info form-control" href="{{ route('downloadPanelFile') }}">{{ __('download_sample_file') }}</a>
                                    </div>
                                    <div class="form-group col-md-3 col-sm-12">
