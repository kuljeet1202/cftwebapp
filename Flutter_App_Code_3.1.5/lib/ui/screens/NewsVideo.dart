    ...
    switch (widget.from) {
      ...
      case 2:
        if (widget.liveModel!.type == "url_youtube") {
          _yc = YoutubePlayerController(initialVideoId: YoutubePlayer.convertUrlToId(widget.liveModel!.url!) ?? "", flags: const YoutubePlayerFlags(autoPlay: true, isLive: true));
        }
        break;
      default:
              ...
              child: Padding(
                  ...
                  child: ClipRRect(
                      ...
                      child: Container(
                          ...
                          child: Icon(Icons.keyboard_backspace_rounded, color: UiUtils.getColorScheme(context).background)))),
            )),
        body: PopScope(
          canPop: true,
