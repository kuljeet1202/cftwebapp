                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: CustomTextLabel(
                                  text: UiUtils.convertToAgo(context, DateTime.parse(data.date!), 0)!,
                                  textAlign: TextAlign.left,
                    ...
                    Padding(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                              mainAxisSize: MainAxisSize.min,
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: List.generate((model.newsType == 'breaking_news') ? model.breakNews!.length : model.breakVideos!.length, (index) {
