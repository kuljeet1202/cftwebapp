...
import 'package:news/ui/screens/Notification/Widgets/NotificationList.dart';
                ...
                Expanded(
                  child: Container(
                      ...
                      child: TabBar(
                          ...
                          tabs: [if (context.read<AuthCubit>().getUserId() != "0") const CustomTextLabel(text: 'personalLbl'), const CustomTextLabel(text: 'newsLbl')])),
                ),
              ])),
        ),
        Padding(padding: const EdgeInsetsDirectional.only(end: 15.0), child: Divider(thickness: 1.5, height: 1.0, color: UiUtils.getColorScheme(context).primaryContainer.withOpacity(0.3)))
      ],
    );
  }
