      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
              ...
              child:
                  CustomTextLabel(text: category.categoryName!, textStyle: TextStyle(fontSize: 16, color: UiUtils.getColorScheme(context).primaryContainer), textAlign: TextAlign.center, maxLines: 2)),
        ],
      ),
    );
  }
