...
class NewsSubDetails extends StatefulWidget {
  ...
  const NewsSubDetails({super.key, this.model, this.breakModel, required this.fromShowMore, required this.isFromBreak});
...
class NewsSubDetailsState extends State<NewsSubDetails> {
  ...
  setNewsViews({required bool isBreakingNews}) {
    Future.delayed(Duration.zero, () {
      context.read<SetNewsViewsCubit>().setSetNewsViews(
