...
class NewsModel {
  ...
  String? bookmark, keyName, tagId, tagName, dislike, totalDislike, subCatId, img, subCatName, showTill, langId, totalViews, locationId, locationName, metaKeyword, metaTitle, metaDescription, slug;
  ...
  factory NewsModel.fromJson(Map<String, dynamic> json) {
    ...
    return NewsModel(
        ...
        totalDislike: json[TOTAL_DISLIKE].toString(),
        history: false,
        type: "news",
        img: "",
